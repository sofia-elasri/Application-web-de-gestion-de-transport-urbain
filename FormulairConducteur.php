     ...
     <div class="contrainer col-md-12">
        ...
        <div class="row">
			  ...
			  <table class="table table-bordered">
				...
				<td><a href = "action2.php?delete=<?php echo $row['Numpermi']?>" class="btn btn-danger">Supprimer</a></td>
				<td><a href ="action2.php?alter=<?php echo $row['Numpermi']?>" class="btn btn-info">modifier</a></td>
				</tr>
				<?php
				}
				?>
			  ...
			  <form  action="action2.php" method="Post">
				...
				?>
				    ...
				    <option  type ="text" "><?php echo $row['MATBUS'];?></option>
